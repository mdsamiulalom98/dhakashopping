...
class ProductController extends Controller
{
    ...
    {
        $data = Product::latest()->select('id', 'name', 'category_id', 'new_price', 'old_price', 'topsale', 'flash_deal', 'feature_product', 'type', 'status')->with('image', 'category')->withSum('variables', 'stock');
        if ($request->keyword) {
    ...
    public function store(Request $request)
    {
        ...
        $input = $request->except(['image', 'product_type', 'files', 'sizes', 'purchase_prices', 'old_prices', 'new_prices', 'stocks', 'images', 'pro_barcodes']);
        ...
        $input['flash_deal'] = $request->flash_deal ? 1 : 0;
        if ($request->type == 0) {
    ...
    public function edit($id)
    {
        ...
        return view('backEnd.product.edit', compact('edit_data', 'categories', 'subcategory', 'childcategory', 'brands', 'sizes', 'variables'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $input = $request->except(['image', 'product_type', 'files', 'sizes', 'purchase_prices', 'old_prices', 'new_prices', 'stocks', 'images', 'up_id', 'up_sizes', 'up_purchase_prices', 'up_old_prices', 'up_new_prices', 'up_stocks', 'up_images', 'pro_barcodes', 'up_pro_barcodes']);
    ...
    {
        $products = Product::whereIn('id', $request->input('product_ids'))->update(['flash_deal' => $request->status]);
        return response()->json(['status' => 'success', 'message' => 'Flash deals product status change']);
    }
