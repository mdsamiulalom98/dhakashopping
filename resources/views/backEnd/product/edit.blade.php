                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('products.update') }}" method="POST" class="row" data-parsley-validate=""
                            ...
                            <div class="col-sm-3 mb-3">
                                <div class="form-group">
                                    <label for="topsale" class="d-block">Best Sales</label>
                                    <label class="switch">
                            ...
                            <div class="col-sm-3 mb-3">
                                <div class="form-group">
                                    <label for="flash_deal" class="d-block">Flash Sales</label>
                                    <label class="switch">
                                        <input type="checkbox" value="1" name="flash_deal"
                                            @if ($edit_data->flash_deal == 1) checked @endif>
                                        <span class="slider round"></span>
                                    </label>
                                    @error('flash_deal')
                                        <span class="invalid-feedback" role="alert">
