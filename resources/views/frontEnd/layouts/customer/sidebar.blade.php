...
<div class="sidebar-menu">
    <ul>
        ...
        <li>
            <a href="{{ route('customer.monthly_reminder') }}" class="{{ request()->is('customer/monthly-reminder') ? 'active' : '' }}">
        ...
        <li>
            <a href="{{ route('customer.profile_edit') }}"
                class="{{ request()->is('customer/profile-edit') ? 'active' : '' }}">
        ...
        <li>
            <a href="{{ route('customer.change_pass') }}"
                class="{{ request()->is('customer/change-password') ? 'active' : '' }}">
