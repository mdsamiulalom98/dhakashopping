...
<body class="gotop">
                        ...
                        <div class="col-sm-12">
                            <div class="logo-header">
                                ...
                                <div class="main-search">
                                    <form action="{{ route('search') }}">
                                        <div class="main-search-category">
                ...
                <div class="main-menu">
                    <ul class="main-menu-ul">
                        <li class="main-menu-list">
                            <a href="{{ route('home') }}"
                                class="main-menu-link {{ Route::currentRouteName() == 'home' ? 'active' : '' }}">
                                <div class="main-menu-item">
                                    <p class="menu-text-label">Home</p>
                                </div>
                            </a>
                        </li>
                        @foreach ($categories as $key => $value)
                            <li class="main-menu-list">
                                <a href="{{ route('category', $value->slug) }}"
                                    class="main-menu-link {{ request('slug') }}">
                                    <div class="main-menu-item">
                                        <p class="menu-text-label">{{ $value->name }}</p>
    ...
    <div class="d-flex">
        <div class="sidebar-wrap">
            <div class="sidebar-inner">
                ...
                <div class="wsit-sidebar-offer">
                    <a href="" class="wsit-offer-link">
                        <div class="wsit-offer-left">
                            <div class="wsit-offer-image">
                                @include('frontEnd.layouts.svg.flash')
                            </div>
                            <div class="wsit-offer-title">
                                <p>Flash Sale</p>
                            </div>
                        </div>
                        <div class="wsit-offer-right">
                            <span class="wsit-offer-toggle">
                                        ...
                                        <ul class="third-nav" style="display: none;">
                                            @foreach ($subcategory->childcategories as $childcat)
                                                <li class="childcategory"><a
                                                        ...
                                                        class="menu-childcategory-name">{{ $childcat->name }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </li>
                                ...
                                <div class="footer-menu">
                                    ...
                                    <ul>
                                        <li class="delivery-partner">
                                            <img src="{{ asset('public/frontEnd/images/payments-footer.png') }}"
                                                alt="">
                                        </li>
                                    </ul>
                ...
                <div class="footer-bottom">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="copyright">
                                    <p>Copyright © {{ date('Y') }} {{ $generalsetting->name }}. All rights
                                        reserved.
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $("#page-overlay").hide();
                            $("#variable-modal").hide();
                            return cart_count() + mobile_cart() + cart_toggle() + mini_cart();
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#categorySelect').change(function() {
                ...
                // Set the text to another element (e.g., input field)
                $('.product-cat-label').text(selectedText);
            });
        });
    </script>
    ...
    <script>
        ...
        $(window).on('scroll', function() {
            ...
            lastScrollTop = currentScroll <= 0 ? 0 : currentScroll; // Ensure no negative scroll values
        });
    </script>
    <script src="{{ asset('public/frontEnd/js/owl.carousel.min.js') }}"></script>
