                ...
                <div class="col-sm-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li><a
                                    href="{{ route('category', $details->category->slug) }}">{{ $details->category->name }}</a>
                            </li>
                            @if ($details->subcategory)
                                ...
                                @endif @if ($details->childcategory)
                                    ...
                                    <li> <a
                                            href="{{ route('products', $details->childcategory->slug) }}">{{ $details->childcategory->name }}</a>
                                    </li>
                                @endif
                                <span>
                                    <i data-feather="chevron-right"></i>
                                    ...
                                    <div class="slider-container">
                                        ...
                                        <div class="swiper swiper-thumbs">
                                            <div class="swiper-wrapper">
                                                @foreach ($details->images as $key => $value)
                                                    <div class="swiper-slide"><img src="{{ asset($value->image) }}"
                                                            alt="Thumb 1">
                                                    </div>
                                                @endforeach
                                            </div>
                                        ...
                                        <div class="swiper swiper-main">
                                            <div class="swiper-wrapper">
                                                @foreach ($details->images as $key => $value)
                                                    <div class="swiper-slide"><img class="block__pic"
                                                            src="{{ asset($value->image) }}" alt="Slide 1">
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-cart">
                                                ...
                                                @if ($details->variable_count > 0 && $details->type == 0)
                                                    ...
                                                    @if ($details->variable->old_price)
                                                        <div class="details-discount">
                                                            @include('frontEnd.layouts.svg.discountribbon')
                                                            @php
                                                                $oldPrice = $details->variable->old_price ?? 0;
                                                                $newPrice = $details->variable->new_price ?? 0;
                                                                $discount =
                                                                    $oldPrice > 0
                                                ...
                                                @else
                                                    ...
                                                    @if ($details->old_price)
                                                        <div class="details-discount">
                                                            @include('frontEnd.layouts.svg.discountribbon')
                                                            @php
                                                                $oldPrice = $details->old_price ?? 0;
                                                                $newPrice = $details->new_price ?? 0;
                                                                $discount =
                                                                    $oldPrice > 0
                                                                        ? (($oldPrice - $newPrice) * 100) / $oldPrice
                                                                        : 0;
                                            ...
                                            <form action="{{ route('cart.store') }}" method="POST" name="formName">
                                                ...
                                                <div class="d-flex single_product col-sm-12">
                                                    <input type="submit" class=" px-4 add_cart_btn"
                                                        onclick="return sendSuccess();" name="add_cart"
                                                        value="Add To Cart " id="add_cart_btn" />

                                                    <input type="submit" class=" px-4 order_now_btn order_now_btn_m"
            ...
            <div class="row">
                <div class="col-sm-7">
                    <div class="details-tab">
                        ...
                        <div class="">
                            <div class="description-tab-wrapper details-desc-item" id="description-tab-pane">
                            ...
                            <div class="review-tab-wrapper details-desc-item" id="review-tab-pane">
                                <div class="desc-item-header">
                                    <h3>Review</h3>
                                </div>
                                <div class="row">
    ...
    <script>
        $(document).ready(function() {
            ...
            var thumbSwiper = new Swiper(".swiper-thumbs", {
                ...
                spaceBetween: 10,
                freeMode: true,
                watchSlidesProgress: true, // Sync progress with main slider
            });
            ...
            var mainSwiper = new Swiper(".swiper-main", {
                ...
                // },
                thumbs: {
                    swiper: thumbSwiper, // Connect with thumbnail slider
                },
            });
        });
    </script>
